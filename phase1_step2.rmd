...
# creating object 
sdc_obj <- createSdcObj(dat = pri_data, keyVars = c("age_group", "sex", "citizenship", "education", "marital_status", "zip"))

sdc_obj_k <- createSdcObj(dat = pri_data, keyVars = c("age_group", "citizenship", "marital_status", "zip"))
print(sdc_obj_k, type="kAnon")
print(sdc_obj_k, "risk")
print(sdc_obj_k@keyVars)
...
pri_data$marital_status <- mapvalues(pri_data$marital_status, from=c("Divorced", "Married/separated", "Never married", "Widowed"), to=c("Not married", "Married", "Not married", "Not married"))
...
# delete the name 
anon_data_pram_global_sex_age <- anonymized_data[, !(colnames(anonymized_data) %in% c("dob", "age"))]
print(anon_data)
